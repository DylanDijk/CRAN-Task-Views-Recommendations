...
mem_change(
rm(TaskView_sources_text, YAML, sections, intro, raw_cln, raw, positions_of_sections_ReproducibleResearch, intro,
   TF, TF_IDF,corpus_word_matrix, TaskView_sources_text, TaskViews_txt,
   titles_descriptions_packages_data, titles_descriptions_packages, titles_descriptions_packages_ls, titles_descriptions_packages_ls_cln,
   word_selector, titles_descriptions_packages_freq,
   titles_descriptions_packages_cosine,
   first, i, idf,n, TaskView, TaskViews, text,
   fun1, fun2, getPackagesWithTitle)
)
)
)
